...
/* function validar() {
    if (registerForm.elements.nombre.value === "" || registerForm.elements.apellido.value === "" || registerForm.elements.mail.value === "" || registerForm.elements.password.value === "") {
        registerButton.disabled = true
        registerButton.classList.add("deshabilitado")
    } if (registerForm.elements.nombre.value.length<3) {
        registerForm.elements.nombre.style.border = "2px solid red";
    }
    else {
        registerButton.disabled = false
        registerButton.classList.remove("deshabilitado")
        registerButton.classList.add("habilitado")
        registerForm.elements.nombre.style.border = "2px solid green";
    }
} */
